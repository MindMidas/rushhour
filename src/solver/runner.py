# CLI helpers for loading Rush Hour puzzles and writing solver results.
...
def get_puzzle(file_number, folder="src/data/boards", file_name=None):
    """
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Run Rush Hour searches with BFS, BestFS, or both",
    ...
    parser.add_argument(
        "--file",
        type=str,
        help="Specify a puzzle file to load and run (e.g., 'src/data/boards/1').\n"
    );
    parser.add_argument(
        "-loop",
        action="store_true",
